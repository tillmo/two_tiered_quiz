...
import UploadQuiz from "../AdminFunctions/UploadQuiz";
...
const AdminLayout = (props) => {
  ...
  const drawer = (
    <div>
      ...
      <Divider />
      <List>
        <ListItem button key={"archive"} onClick={routeToMenu("/adminapp/")}>
          <ListItemIcon style={{ minWidth: "40px" }}>
            <StorageIcon />
          </ListItemIcon>
          <ListItemText
            classes={{ primary: classes.listItemStyle }}
            primary={t("Upload Quiz")}
          />
        </ListItem>
      </List>
      <Divider />
  ...
  return (
    <div className={classes.root}>
      ...
      <AppBar position="fixed" className={classes.appBar}>
        <Toolbar>
          ...
          <Typography variant="h6" noWrap>
            {process.env.REACT_APP_TITLE+" - Admin Panel"}
          </Typography>
      ...
      <main className={classes.content}>
        <div className={classes.toolbar} />
        <Route path={props.match.url + "/"} exact component={UploadQuiz} />
      </main>
    </div>
  );
};
...
export default translate("common")(AdminLayout);