...
import { HasAdminSessionExpired, getErrorMessage } from "../Utils/LoginUtils.js";
import {
  getLoginService,
  getUserDetailsServiceAdm,
  getUserDetailsServiceAdmId,
...
export class AdminLogin extends Component {
  ...
  handleLogin = async (e) => {
    ...
    await getLoginService({
      ...
      .then((res) => {
        localStorage.setItem("admtoken", res.data.key);
        localStorage.setItem("admloggedinTime", Date.now());
        localStorage.setItem("admusername", this.state.username);
    ...
    var user = await getUserDetailsServiceAdmId();
    const isStaff = await getUserDetailsServiceAdm(user);
    if (!isStaff) {
      this.setState({
        openBackDrop: false,
        openSnackBar: true,
...
export default translate("common")(AdminLogin);
